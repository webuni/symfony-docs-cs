.. index::
   pair: Assetic; Přehled konfigurací

Přehled konfigurací balíčku AsseticBundle
=========================================

Úplná výchozí konfigurace
~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    .. code-block:: yaml
        ...
        assetic:
            ...
            filters:
                ...
                # pole pojmenovaných filtrů (např. some_filter, some_other_filter)
                some_filter:                 []
            twig:
                functions:
                    # pole pojmenovaných funkcí (např. some_function, some_other_function)
                    some_function:                 []
